...
interface AuthState {
  ...
  register: (username: string, password: string, email: string, nickname?: string) => Promise<{ message: string }>
  logout: () => Promise<void>
...
export function AuthProvider({ children }: { children: ReactNode }) {
  ...
  const register = useCallback(async (username: string, password: string, email: string, nickname?: string) => {
    setLoading(true)
    try {
