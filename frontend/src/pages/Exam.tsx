...
export default function Exam() {
  ...
  const { sessionId, chatStatus, starting, startSession, closeSession, sendDCMessage, onDCMessage, replaceAudioTrack, cleanupConnection } = useWebRTC(showToast)
  const {
