...
class UserDatabase:
    ...
    def create_user(self, user: UserInfo, hashed_password: str) -> dict:
        ...
        with self._conn.cursor() as cursor:
            cursor.execute(
                "INSERT INTO users (uuid, username, email, hashed_password, nickname, created_at, last_login, is_active, login_count) "
    ...
    def get_user(self, username: str) -> Optional[dict]:
        ...
        with self._conn.cursor() as cursor:
            cursor.execute(
                "SELECT uuid, username, email, hashed_password, nickname, created_at, last_login, is_active, login_count "
    ...
    def get_all_users_info(self) -> list[dict]:
        ...
        with self._conn.cursor() as cursor:
            cursor.execute(
                "SELECT uuid, username, email, nickname, created_at, last_login, is_active, login_count FROM users"
            )
