...
def _setup_webrtc_routes(app: FastAPI, args: argparse.Namespace):
    ...
    @app.post("/api/offer")
    async def offer(request: SmallWebRTCRequest, background_tasks: BackgroundTasks, current_user: dict = Depends(get_current_user)):
        ...
        async def webrtc_connection_callback(connection: SmallWebRTCConnection):
            ...
            runner_args.cli_args = args
            background_tasks.add_task(bot_module.bot, runner_args, current_user)
        ...
        if path.endswith("api/offer"):
            ...
            try:
                ...
                if request.method == HTTPMethod.POST.value:
                    ...
                    return await offer(webrtc_request, background_tasks, current_user)
